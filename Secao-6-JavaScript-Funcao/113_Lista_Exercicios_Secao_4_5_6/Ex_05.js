...
function formatando_Valor_Monetario (p1) {
    const valor_Ajeitado = Intl.NumberFormat('pt-br', {style: 'currency', currency: 'BRL'}).format(p1);
    return console.log(valor_Ajeitado);
};

formatando_Valor_Monetario(0.30000000000000004);
